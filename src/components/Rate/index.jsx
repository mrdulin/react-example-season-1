...
class Rate extends Component {
  ...
  render() {
    ...
    const starItems = stars.map(star => <Star id={star.id} onClick={this.handleClick} onMouseOut={this.handleMouseOut}
                                              onMouseOver={this.handleMouseOver} key={star.id}>{star.content}</Star>)
    return <div>
      {starItems}
    </div>
  }
...
class Star extends Component {
  ...
  render() {
    ...
    return <span style={this.props.starStyle} onClick={this.handleClick} onMouseOut={this.handleMouseOut}
                 onMouseOver={this.handleMouseOver}>{children}</span>
  }

const META_DATA = {
  "items": {
    "react": {
      ...
      "send-ajax-within-constructor-of-component": "在constructor中ajax",
...
const loadMetaData = (dirname) => {
  if (!dirname || !META_DATA[dirname]) return [];
  const keyMap = META_DATA[dirname];
  dirname = dirname.charAt(0).toUpperCase();
